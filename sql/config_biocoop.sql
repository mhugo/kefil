...
delete from items;
insert into items (id, name, category_id, price, grid_x, grid_y, color) values (1, 'BN 1 ingrédient', 1, 0, 1, 1, '#0056b3');
insert into items (id, name, category_id, price, grid_x, grid_y, color) values (2, 'BN 2 ingrédients', 1, 0, 2, 1, '#28a745');
insert into items (id, name, category_id, price, grid_x, grid_y, color) values (3, 'BN 3 ingrédients', 1, 0, 3, 1, '#28a745');
insert into items (id, name, category_id, price, grid_x, grid_y, color) values (4, 'Froment', 2, 0, 1, 2, '#28a745');
insert into items (id, name, category_id, price, grid_x, grid_y, color) values (5, 'Nues', 2, 0, 1, 3, '#28a745');

insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (1, 'Jambon', 1, 300, 1, 1, '#28a745');
insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (1, 'Oeuf', 1, 300, 2, 1, '#28a745');
insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (1, 'Fromage', 1, 300, 3, 1, '#28a745');
insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (1, 'Légumes', 1, 300, 1, 2, '#28a745');
insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (1, 'Beurre BN', 1, 200, 1, 3, '#28a745');
...
insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (4, 'Chocolat', 2, 300, 1, 1, '#ffc107');
insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (4, 'Caramel', 2, 300, 2, 1, '#ffc107');
insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (4, 'Beurre / Sucre', 2, 250, 3, 1, '#ffc107');
insert into items (parent_id, name, category_id, price, grid_x, grid_y, color) values (4, 'Beurre FR', 2, 200, 1, 2, '#ffc107');
